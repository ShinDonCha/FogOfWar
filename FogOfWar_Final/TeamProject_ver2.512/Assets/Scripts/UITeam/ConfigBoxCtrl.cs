...
public class ConfigBoxCtrl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (tutoOpenBtn != null)
            tutoOpenBtn.onClick.AddListener(() => tutoPanel.SetActive(true));
        if (tutoCloseBtn != null)
            tutoCloseBtn.onClick.AddListener(() => tutoPanel.SetActive(false));
    }
